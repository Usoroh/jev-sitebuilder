...
function CheckboxGroup({
  ...
  return (
    <div
      role="group"
      className={cn(
        "relative inline-flex overflow-hidden rounded-md border-2 border-border bg-background shadow-[var(--shadow-hard)]",
        ...
        return (
          <label
            ...
            className={cn(
              ...
              orientation === "vertical" && i > 0 && "border-t-2 border-border",
              orientation === "horizontal" && i > 0 && "border-l-2 border-border"
            )}
          >
            <AnimatePresence>
              {selected && (
            ...
            <span className="relative z-10 flex items-center pt-0.5">
              <span
                className={cn(
                  ...
                  selected
                    ? "border-border bg-foreground text-background shadow-[var(--shadow-hard-sm)]"
