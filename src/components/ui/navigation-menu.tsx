...
function NavigationMenuViewport({
  ...
  return (
    <NavigationMenuPrimitive.Portal>
      ...
      >
        <NavigationMenuPrimitive.Popup className="relative h-[var(--popup-height)] w-full origin-[var(--transform-origin)] overflow-hidden rounded-md border-2 border-border bg-popover text-popover-foreground shadow-[var(--shadow-hard)] transition-[opacity,transform,scale,width,height] duration-150 data-starting-style:scale-90 data-ending-style:scale-95 md:w-[var(--popup-width)]">
