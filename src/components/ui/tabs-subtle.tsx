...
// selected tab. Ported from fluid-functionalism (mickadesign), simplified
// to drop proximity-hover/shape-context — uses motion's layoutId for the
// active pill and a CSS hover state for the hover highlight.
//
// Usage:
