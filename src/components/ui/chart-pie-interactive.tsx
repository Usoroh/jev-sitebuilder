...
// ChartStyle is inlined here because not every design system's chart primitive
// re-exports it. Injects per-key `--color-*` CSS vars for the chart's config. [BD-194]
...
${colorConfig
  .map(([key, itemConfig]) => {
    const c = itemConfig as { color?: string; theme?: Record<string, string> }
