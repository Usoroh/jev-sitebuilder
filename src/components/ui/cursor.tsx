  ...
  return (
    <div className={cn("relative inline-flex flex-col gap-2", className)}>
      <AnimatePresence>
        {(isTyping || displayedText) && (
          <motion.div
            ...
            className="rounded-md border-2 border-border bg-card px-3 py-2 text-sm text-foreground shadow-[var(--shadow-hard)] ring-1 ring-border/20"
      ...
      {label && (
        ...
        >
          <div
            className="h-2.5 w-2.5 rounded-full shadow-[var(--shadow-hard-sm)]"
            style={{ backgroundColor: color }}
          />
