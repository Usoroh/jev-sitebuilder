...
// Retro-Playful Steps / Stepper component
        ...
        return (
          ...
          >
            ...
            >
              ...
              <div
                className={cn(
                  "flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-2 border-border text-sm font-medium transition-colors",
                  isCompleted && "bg-primary text-primary-foreground shadow-[var(--shadow-hard-sm)]",
