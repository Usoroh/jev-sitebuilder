...
// Retro-Playful Tag Input: input for adding/removing tags
...
function TagInput({
  ...
  return (
    <div
      className={cn(
        "flex min-h-10 w-full flex-wrap gap-1.5 rounded-lg border-2 border-border bg-background px-3 py-2 shadow-[var(--shadow-hard-sm)]",
        "transition duration-200 focus-within:border-foreground",
        "cursor-text",
