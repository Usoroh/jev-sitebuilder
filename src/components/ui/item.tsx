...
// Retro-Playful Item: settings row / menu item / list item
// Left: icon/avatar slot + text (title + subtitle)
// Right: optional action (button, badge, toggle)
// Light theme: hover:bg-secondary/60, h-14 default, border-b-2 border-border
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          "rounded-lg border-2 border-border bg-card text-card-foreground shadow-[var(--shadow-hard)]",
          "text-left",
          interactive && [
            "cursor-pointer",
