...
// Retro-Playful Chart: recharts-based with Linear styling
// Uses bg-background, border-border, rounded-lg
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "rounded-lg border-2 border-border bg-background px-3 py-2 shadow-[var(--shadow-hard)] text-xs",
          className
        )}
      >
