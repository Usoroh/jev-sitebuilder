...
// Retro-Playful Stat Card: displays a metric with label, value, and optional change indicator
            ...
            {change && (
              <span
                className={cn(
                  ...
                  change.trend === "up" && "bg-[oklch(0.6889_0.1644_152.71)]/15 text-foreground",
