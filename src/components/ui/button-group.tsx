...
// Retro-Playful ButtonGroup: groups buttons horizontally, removes inner rounded edges
// Outer buttons keep rounded-lg, inner buttons get flat edges where they meet
